...
void ui_games_init(void)
{
      ...
      // ui_raceScreen_screen_init(registerGame_cb);  // Racing game not implemented
      ui_imuScreen_screen_init(registerGame_cb);
      ui_navScreen_screen_init(registerGame_cb);
      // ui_simonScreen_screen_init(registerGame_cb);  // Simon game not implemented
...
{
      // ui_raceScreen_screen_loop();  // Racing game not implemented
}
